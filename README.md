...
- AI 활용자 전용 데이터: `chatbot_output_ai_users_selected.csv`
- 전체 응답자 수: 1,608명
- AI 활용자 수: 377명
...
- `effect`: `Q7_1` ~ `Q7_5` 평균
- `support`: `Q16_1` ~ `Q16_7` 평균
- `expectation`: `Q20_1` ~ `Q20_4` 평균
...
- Harman의 단일요인 검정은 공통방법편의를 완전히 배제하는 강한 검정이 아니므로, 결과 해석 시 그 한계를 함께 명시해야 한다.
