...
with markdown_output("17_measurement_validity_q16_excluded.md") as result_path:
    print("# 17 Q16_7 제외 전후 측정타당성 비교\n")
    ...
    print("- 제외 버전에서 AVE, CR, HTMT가 더 안정적이면 Q16_7 제외 결정은 내용타당성과 판별타당성 측면에서 더 설득력 있다.")
